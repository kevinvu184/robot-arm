...
public class Robot extends JPanel
{
    ...
    public void drawObject(final Graphics paramGraphics, final int paramInt1, final int paramInt2, final int paramInt3) {
        if (paramInt2 > 0) {
            paramGraphics.setColor(Color.black);
        ...
        if (paramInt3 > 0) {
            ...
            paramGraphics.setColor(Color.black);
            paramGraphics.drawString(new StringBuilder().append(paramInt3).toString(), 220 + paramInt1 * 50, 420 - (paramInt2 + paramInt3) * 30);
        }
    }
    ...
    public void drawItems(final Graphics paramGraphics) {
        ...
        for (int i = 0; i < this.numItems; ++i) {
            this.itemsHt -= this.blocksDepth[i] * 30;
            this.htItems1 += this.blocksDepth[i];
            paramGraphics.drawString(new StringBuilder().append(this.blocksDepth[i]).toString(), 570, this.itemsHt + this.blocksDepth[i] * 15);
        }
        this.htItems2 = 0;
        this.itemsHt2 = 400;
        for (int i = 0; i < this.numItems2; ++i) {
            ...
            paramGraphics.drawString(new StringBuilder().append(this.newBlocksDepth[i]).toString(), 120, this.itemsHt2 + this.newBlocksDepth[i] * 15);
        }
        this.htItems3 = 0;
        this.itemsHt3 = 400;
        for (int i = 0; i < this.numItems3; ++i) {
            ...
            paramGraphics.drawString(new StringBuilder().append(this.newBlocksDepth2[i]).toString(), 170, this.itemsHt3 + this.newBlocksDepth2[i] * 15);
        }
    }
    ...
    public void drawRobot(final Graphics paramGraphics) {
        ...
        if (this.picked) {
            ...
            paramGraphics.drawString(new StringBuilder().append(this.currentHeight).toString(), 70 + this.rW * 50, 400 - this.rH * 30 + this.rD * 30 + 30 + this.currentHeight * 15);
        }
    }
